GOG Checksum Tool
---
This script will use the [GOG API](https://gogapidocs.readthedocs.io/en/latest) 
to download a list of checksums for a given game/product installer.
...
The product id can easily be obtained by searching 
[GOG DB](https://www.gogdb.org). Let's say we want to download the checksums 
for *Resident Evil 3*. We can search GOG DB and eventually we'll find this 
[page](https://www.gogdb.org/product/1266089300), which the product id can 
either be grabbed from the URL or directly from the table contents listed front 
and center. Hint, the product id in this case will be ***1266089300***.
...
I typically store my game installers in a directory like, *Downloads/GOG*, 
which is where I would also copy this script into.
